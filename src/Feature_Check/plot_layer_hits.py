...
data = torch.load(os.path.join(data_dir, "processed_data_0001_v5.pt"))
...
tolerance = 0.05  # ± tolerance around target value
...
plt.ylabel("Mean Measured Hits per Layer")
